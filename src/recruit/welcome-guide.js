...
export function buildWelcomeGuideEmbeds(runtime, recruitConfig = null) {
  ...
  const embed1 = new EmbedBuilder()
    ...
    .setDescription([
      ...
      '',
      'So I built **KRAKEN** — not to nag you on Discord, but to keep **honest clan records** that actually last:',
      '```',
  ...
  const embed2 = new EmbedBuilder()
    ...
    .addFields(
      ...
      },
      {
        name: '🐛 BUGS',
        value: [
          'KRAKEN is built for our clan and tuned as we go — issues only show up once real wars are running.',
          '',
          `Wrong number, wrong role, something broken? Tell me in ${feedbackRef} and I'll get it fixed.`,
          '',
          '_Appreciate any feedback — it makes the bot better for everyone._',
          '',
          SEP,
        ].join('\n'),
      },
